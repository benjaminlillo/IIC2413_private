    ...
    <div id="navbarBasicExample" class="navbar-menu">
      <div class="navbar-start">
        <div id='titulo' class='navbar-item'>
          <?php echo "<p class='subtitle is-5'>" . $titulo . "</p>"; ?> 
        </div>
      ...
      <div class="navbar-end">
        <div class="navbar-item">
          <form action="http://codd.ing.puc.cl/~grupo2/register.php" method="post">
            <input class="button is-primary" type="submit" name="boton_registrar" value="Registrarse">
          </form>
        </div>
        <div class="navbar-item">
          <form action="http://codd.ing.puc.cl/~grupo2/index.php" method="post"> 
